...
builder.Services.AddScoped<IInvestmentToolService, InvestmentToolService>();
builder.Services.AddScoped<IInvestmentToolRepository, InvestmentToolRepository>(); 
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Investment Application", Version = "v1" });
